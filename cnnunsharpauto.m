...
% 15. نمایش تصاویر
figure;
subplot(1, 3, 1); imshow(cleanImage); title('تصویر تمیز');
subplot(1, 3, 2); imshow(denoisedImage); title('تصویر بدون نویز توسط CNN');
subplot(1, 3, 3); imshow(reconstructedImage); title('تصویر بازسازی شده توسط اتوانکدر');
